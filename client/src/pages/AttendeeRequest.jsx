    ...
    <div className="min-h-screen bg-gray-900 p-4">
      <div className="mx-auto max-w-2xl">
          ...
          {event.genre_tags && event.genre_tags.length > 0 && (
            <div className="mt-3 flex flex-wrap justify-center gap-2">
              {event.genre_tags.map((tag, idx) => (
                <span key={idx} className="rounded-full bg-gray-800 px-3 py-1 text-sm">
                  {tag}
                </span>
              ))}
            </div>
        ...
        <form onSubmit={handleSubmit} className="mb-8 rounded-lg bg-gray-800 p-6">
          ...
          <div className="mb-6">
            <label htmlFor="requester_name" className="mb-2 block text-sm font-medium">
              Your Name (optional)
            </label>
            <input
              type="text"
          ...
          <button
            type="submit"
            disabled={submitting}
            className="w-full rounded-lg bg-venmo px-6 py-3 font-semibold text-white hover:bg-blue-600 disabled:opacity-50 active:scale-95"
          >
        ...
        {event.queue_visible && (
          <div className="rounded-lg bg-gray-800 p-6">
            <h2 className="mb-4 text-xl font-semibold">Live Queue</h2>
            ...
            {requests.length === 0 ? (
              ...
              <div className="space-y-3">
                {requests.map((request) => (
                  <div key={request.id} className="rounded-lg bg-gray-700 p-4">
